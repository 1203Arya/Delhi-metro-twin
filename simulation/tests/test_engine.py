...
def test_engine_initialize():
    ...
    network_data = {
        ...
        "stations": [
            {"id": "s1", "code": "STA", "name": "Station A", "line_code": "RED", "sequence": 1},
            {"id": "s2", "code": "STB", "name": "Station B", "line_code": "RED", "sequence": 2},
            {"id": "s3", "code": "STC", "name": "Station C", "line_code": "RED", "sequence": 3},
        ],
        "track_segments": [
            {
                "block_id": "blk_0", "line_code": "RED", "direction": "up",
                "from_station_id": "s1", "to_station_id": "s2",
                "from_station_code": "STA", "to_station_code": "STB",
                "length_m": 1000.0, "sequence": 0, "speed_limit_kmh": 80.0,
            },
            {
                "block_id": "blk_1", "line_code": "RED", "direction": "up",
                "from_station_id": "s2", "to_station_id": "s3",
                "from_station_code": "STB", "to_station_code": "STC",
                "length_m": 1000.0, "sequence": 1, "speed_limit_kmh": 80.0,
            },
        ],
        "depots": [{"name": "depot_RED", "code": "depot_RED", "line_code": "RED"}],
        "train_classes": [
            {"train_class_id": "std", "max_speed_kmh": 80.0, "acceleration_ms2": 0.8, "deceleration_ms2": 0.9},
        ],
    }
