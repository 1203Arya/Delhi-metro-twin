...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_stations_line_code"), "stations", ["line_code"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_crossovers_line_code"), "crossovers", ["line_code"], unique=False
    )
    op.create_index(
        op.f("ix_crossovers_station_id"), "crossovers", ["station_id"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_junctions_station_id"), "junctions", ["station_id"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "geometry",
            geoalchemy2.types.Geometry(geometry_type="POLYGON", srid=4326, dimension=2),
            nullable=False,
        ),
        sa.Column("heading_deg", sa.Float(), nullable=False),
        sa.Column("length_m", sa.Float(), nullable=False),
    ...
    op.create_index(
        op.f("ix_platforms_station_id"), "platforms", ["station_id"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_track_segments_from_station_id"),
        "track_segments",
        ["from_station_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_track_segments_line_code"),
        "track_segments",
        ["line_code"],
        unique=False,
    )
    op.create_index(
        op.f("ix_track_segments_to_station_id"),
        "track_segments",
        ["to_station_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_switches_junction_id"), "switches", ["junction_id"], unique=False
    )
    op.create_index(
        op.f("ix_switches_line_code"), "switches", ["line_code"], unique=False
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_track_segments_from_station_id"), table_name="track_segments"
    )
