...
RED = {
    ...
    "stations": [
        ...
        S("Shaheed Nagar", "SHN", 28.6720, 77.3280),
        S("Raj Bagh", "RJB", 28.6720, 77.3380),
        S("Major Mohit Sharma Rajendra Nagar", "MMS", 28.6730, 77.3480),
        S("Shyam Park", "SYP", 28.6735, 77.3580),
        S("Mohan Nagar", "MHN", 28.6730, 77.3680),
        S("Arthala", "ATH", 28.6730, 77.3820),
        S("Hindon River", "HDR", 28.6734, 77.4064),
...
YELLOW = {
    ...
    "stations": [
        ...
        S("Haiderpur Badli Mor", "HBM", 28.7400, 77.1680, junction=True, interchange=["MG"]),
        ...
        S("Chandni Chowk", "CHC", 28.6530, 77.2240, structure="underground"),
...
GREEN = {
    ...
    "stations": [
        ...
        S("Paschim Vihar West", "PVW", 28.6730, 77.0950),
...
PINK = {
    ...
    "number": 8,
    "color_hex": "#E8A0BF",
    "corridor": "Majlis Park – Maujpur-Babarpur (Ring)",
    "opened_year": 2018,
    "operator": "DMRC",
    "gauge_mm": 1435,
    "electrification": "25 kV AC OHE",
    "signalling_system": "ATP",
    "total_length_km": 71.56,
    "depots": [D("Majlis Park Depot", 28.7150, 77.1800, 85_000, 52)],
    "stations": [
        # ── Phase 4 extension (opened 8 Mar 2026): Majlis Park – Maujpur-Babarpur ──
        S("Majlis Park", "MJP", 28.7150, 77.1800, junction=True, interchange=["MG"]),
        S("Burari", "BRI", 28.7260, 77.1860),
        S("Jharoda Majra", "JHM", 28.7310, 77.2050),
        S("Jagatpur - Wazirabad", "JGW", 28.7280, 77.2300),
        S("Soorghat", "SGH", 28.7200, 77.2550),
        S("Nanaksar - Sonia Vihar", "NSV", 28.7100, 77.2720),
        S("Khajuri Khas", "KJK", 28.7000, 77.2850),
        S("Bhajanpura", "BJP", 28.6930, 77.2920),
        S("Yamuna Vihar", "YMV", 28.6860, 77.2980),
        # ── Eastern arc (original Phase 3 section) ──
        S("Maujpur - Babarpur", "MUP", 28.6920, 77.2800, junction=True),
        S("Gokulpuri", "GKP", 28.6980, 77.2950),
        S("Johri Enclave", "JHE", 28.7020, 77.3100),
        S("Shiv Vihar", "SVH", 28.6500, 77.3380, terminus=True),
        S("Jaffrabad", "JFB", 28.6830, 77.2760),
        S("Welcome", "WLC", 28.6725, 77.2780, junction=True, interchange=["RD"]),
        S("East Azad Nagar", "EAN", 28.6300, 77.3200),
        S("Krishna Nagar", "KRN", 28.6380, 77.3260),
        S("Karkarduma Court", "KKC", 28.6420, 77.3060),
        S("Karkarduma", "KKD", KKD[0], KKD[1], junction=True, interchange=["BR"]),
        S("Anand Vihar", "ANV", AV[0], AV[1], junction=True, interchange=["BR"]),
        S("IP Extension", "IPE", 28.6340, 77.3030),
        S("Mandawali - West Vinod Nagar", "MWV", 28.6280, 77.3000),
        S("East Vinod Nagar - Mayur Vihar-II", "EVN", 28.6240, 77.2980),
        ...
        S("Sarai Kale Khan - Nizamuddin", "HZN", 28.5780, 77.2640),
        ...
        S("Sarojini Nagar", "SJN", 28.5750, 77.2000),
        ...
        S("Punjabi Bagh West", "PBW", 28.6690, 77.1300, junction=True, interchange=["GR"]),
...
MAGENTA = {
    ...
    "number": 9,
    "color_hex": "#8E44AD",
    "corridor": "Deepali Chowk – Botanical Garden (via Majlis Park, Janakpuri West)",
    "opened_year": 2017,
    "operator": "DMRC",
    "gauge_mm": 1435,
    "electrification": "25 kV AC OHE",
    "signalling_system": "ATP",
    "total_length_km": 50.18,
    "depots": [D("Janakpuri Depot", 28.6293, 77.0800, 70_000, 44)],
    "stations": [
        S("Deepali Chowk", "DPC", 28.7300, 77.1000, terminus=True),
        S("Madhuban Chowk", "MDC", 28.7160, 77.1150, junction=True, interchange=["RD"]),
        S("Uttari Pitampura - Prashant Vihar", "UPP", 28.7220, 77.1400),
        S("Haiderpur Village", "HPV", 28.7300, 77.1600),
        S("Haiderpur Badli Mor", "HBM", 28.7400, 77.1680, junction=True, interchange=["YL"]),
        S("Bhalaswa", "BLS", 28.7300, 77.1780),
        S("Majlis Park", "MJP", 28.7150, 77.1800, junction=True, interchange=["PK"]),
        S("Krishna Park Extension", "KPE", 28.6320, 77.0820),
        S("Janakpuri West", "JNW", JW[0], JW[1], junction=True, interchange=["BL"]),
        S("Dabri Mor - Janakpuri South", "DBM", 28.6200, 77.0920),
        S("Dashrathpuri", "DTP", 28.6120, 77.0980),
        ...
        S("Panchsheel Park", "PSP", 28.5400, 77.2150),
        S("Chirag Delhi", "CHD", 28.5360, 77.2250),
        S("Greater Kailash", "GRK", 28.5390, 77.2380),
        S("Nehru Enclave", "NHE", 28.5400, 77.2480),
        ...
        S("Okhla Bird Sanctuary", "OBS", 28.5480, 77.3160),
        S(
            "Botanical Garden",
            "BGA",
            BG[0],
    ...
    "interchanges": [
        IC("MDC", "RD", "Madhuban Chowk"),
        IC("HBM", "YL", "Haiderpur Badli Mor"),
        IC("MJP", "PK", "Majlis Park"),
